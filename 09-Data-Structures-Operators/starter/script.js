...
// console.log(announcement.replaceAll('door', 'gate')); // error
console.log(announcement.replace(/door/g, 'gate')); /// use /.../g  มันใช้แทน replaceAll
...
// array
const users = [{name:'Jonas',email:'pin@gmail.io'}];
