...
function checkDogs(dogsJulia,dogsKate){
  let JuliacutCat = dogsJulia.slice(1,3);
  console.log(JuliacutCat);

  const sumdog = JuliacutCat.concat(dogsKate);
  console.log(sumdog);

  sumdog.forEach(function(value,i){
    if(value >= 3){
...
console.log(`${ownersEatTooMuch.join(' and ')}'s doges eat too much!`);
console.log(`${ownersEatTooLittle.join(' and ')}'s doges eat too little!`);
